...
class _PreviewScreenState extends State<PreviewScreen> {
  ...
  ConversionType get _effectiveType {
    return widget.existingDocument?.documentType ?? widget.conversionType;
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (images.isEmpty) {
      return Scaffold(
        backgroundColor: isDark ? AppTheme.bgDark : const Color(0xFFF1F4F3),
        appBar: AppBar(
          backgroundColor:
    ...
    final int safeIndex = _currentPageIndex.clamp(0, totalPages - 1);
            ...
            child: SizedBox(
              ...
              child: Container(
                ...
                child: Stack(
                  ...
                  children: [
                    // ==========================================
                    // IMAGE WITH HIGH RESOLUTION ZOOM
                    // ==========================================
                    InteractiveViewer(
                      minScale: 1.0,
                      maxScale: 5.0,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(
              _isPpt ? Icons.slideshow_rounded : Icons.description_outlined,
              size: 48,
              color: _effectiveType.badgeColor,
            ),
          ),
          ...
          Text(
            _isPpt ? 'No slides to preview' : 'No pages to preview',
